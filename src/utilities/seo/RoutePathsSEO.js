...
export const SITE_NAME = 'appmint ';
export const AUTHOR = 'Nouthemes';
export const CREATOR_ID = 'Nouthemes';

const mainHeadData = {
    '/': {
        title: 'appmint - React Ecommerce Template',
        desc: "Elevate your online store with appmint React Template. Customizable, SEO-friendly, and user-centric design. Secure payments, intuitive navigation. Unleash your store's potential.",
        canonical: SITE_URL,
        isIndexed: true,
        followLinks: true,
        lastmod: '2024-01-01',
